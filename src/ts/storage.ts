...
export const enableVideoFlowOverlay = stores.addSyncStore('hc.flowOverlay.enabled', true);
export const flowOverlayMaxVisible = stores.addSyncStore('hc.flowOverlay.maxVisible', 24);
export const flowOverlayAreaTopPercent = stores.addSyncStore('hc.flowOverlay.areaTopPercent', 8);
export const flowOverlayAreaHeightPercent = stores.addSyncStore('hc.flowOverlay.areaHeightPercent', 72);
export const flowOverlayMaxPerSecond = stores.addSyncStore('hc.flowOverlay.maxPerSecond', 12);
export const flowOverlayMaxDelayMs = stores.addSyncStore('hc.flowOverlay.maxDelayMs', 12000);
